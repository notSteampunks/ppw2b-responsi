...
<!-- content -->
@section('content')
<form method="POST" action="{{ route('list.update', $homestay->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
        <label for="inputNama" class="form-label">Homestay Name</label>
        <input type="text" name="nama" class="form-control" value="{{$homestay->nama}}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="lokasi" class="form-control" value="{{$homestay->lokasi}}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="date" id="tgl_terbit" name="tgl_terbit" class="date form-control" value="{{$homestay->tgl_terbit}}">
    </div>
